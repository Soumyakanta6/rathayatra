        ...
        <div className="footer-container">
          ...
          <div className="footer-column brand-column">
            <div className="footer-logo">
              ...
              <span className="footer-title">Jagannath Ratha Yatra</span>
            </div>
            <p className="footer-tagline">
              Experience the divine celebration of Lord Jagannath's sacred chariot procession at Prestige Finsbury Park, Bangalore—where devotion, tradition, and community come together.
            </p>
          </div>
          ...
          <div className="footer-column">
            ...
            <div className="contact-list">
              <div className="contact-row">
                ...
                <a href="mailto:jagannathrathayatra.pfp@gmail.com">jagannathrathayatra.pfp@gmail.com</a>
              </div>
              <div className="contact-row">
                <span className="contact-icon">📍</span>
                <span>Prestige Finsbury Park, Gunjur, Bangalore, Karnataka</span>
              </div>
              <div className="contact-row">
                <span className="contact-icon">📞</span>
                <a href="tel:+919739344477">+91 97393 44477</a>
              </div>
            </div>
          </div>
          ...
          <div className="footer-column newsletter-column">
            ...
            <p className="newsletter-text">Stay connected—subscribe for the latest news and updates.</p>
      ...
      <div className="footer-copyright-bar">
        <div className="footer-container copyright-container">
          <p className="copyright-text">
            Copyright © 2026 Jagannath Ratha Yatra - Prestige Finsbury Park. 
            <span className="powered-by">Made with ❤️ by Community</span>
          </p>
